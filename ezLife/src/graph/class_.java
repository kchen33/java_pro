...
class class_ extends JFrame implements ActionListener{
	Job oneclass ;
	...
	public class_(){
		...
		oneclass = new Job("noclass", null,null,false);
		...
		add.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e) {
				...
				String cldatey = datey.getText();
				String cldatem = datem.getText();
				String cldated = dated.getText();
				String clstimeh = stimeh.getText();
				String clstimem = stimem.getText();
				String cletimeh = etimeh.getText();
				String cletimem = etimem.getText();
				Time stime = new Time(cldatey, cldatem,cldated, clstimeh, clstimem);
				Time etime = new Time(cldatey, cldatem, cldated, cletimeh, cletimem);
				Job newclass = new Job(clname, stime, etime, false);
